...
const CARACTERISTICAS = [
  ...
  {
    nombre: '2.6 Coordenadas geográficas [Latitud]',
    tipo_dato: 'texto',
    opciones: [],
    requerido: true,
    orden: 6,
  ...
  {
    nombre: '2.7 Coordenadas geográficas [Longitud]',
    tipo_dato: 'texto',
    opciones: [],
    requerido: true,
    orden: 7,
  ...
  {
    nombre: '2.9 Década estimada de la Construcción',
    tipo_dato: 'seleccion',
  ...
  {
    nombre: '2.11 Número de niveles sobre el terreno',
    tipo_dato: 'seleccion',
  ...
  {
    nombre: '2.13 Número de ocupantes',
    tipo_dato: 'numero',
    opciones: [],
    requerido: false,
    orden: 13,
  ...
  {
    nombre: '2.14 Tipo de inspección',
    tipo_dato: 'seleccion',
