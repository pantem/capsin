...
class NuevoDamnificadoScreen extends StatefulWidget {
  ...
  const NuevoDamnificadoScreen({super.key, required this.reporteId});
                  ...
                  children: [
                    ...
                    SegmentedButton<String>(
                      segments: const [
                        ...
                        ButtonSegment(
                            value: 'lesionado_leve',
                            label: Text('Lesión leve'),
                            icon:
                                Icon(Icons.healing, color: Colors.orange)),
                        ButtonSegment(
                            value: 'lesionado_grave',
                            label: Text('Lesión grave'),
                            icon: Icon(Icons.local_hospital,
                                color: Colors.red)),
                        ButtonSegment(
                            value: 'fallecido',
                            label: Text('Fallecido'),
